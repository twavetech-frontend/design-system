...
export function modifyColor(baseColor, modifier) {
    ...
    const modifyValueResolvedCalc = Number(parseAndReduce(modifier.value, defaultFractionDigits));
    try {
        switch (modifier.type) {
            ...
            case 'darken':
                ...
                break;
            case 'mix':
                returnedColor = mix(color, modifier.space, modifyValueResolvedCalc, new Color(modifier.color));
                break;
            case 'alpha': {
